    ...
    <div className="mt-12">
        ...
        <div className="bg-white dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">Rwf 450,000</p>
            </div>
          </div>
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl m-3 p-4 md:w-780">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-ceter">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl font-semibold">Rwf 500,678</span>
                  <span className="p-1.5 hover:drop-shadow-xl rounded-full bg-green-400 ml-3 text-sx text-white">
                    23%
                  </span>
                </p>
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">Rwf 680,999</span>
                  
                </p>

                <p className="text-gray-500 mt-1">Expenset</p>
              </div>
